...
admWallet = account[0]  # exemplo: conta admin
ongWallet = account[2]  # exemplo: conta ONG
...
private_key = PRIVATE_KEY  # sua chave privada, preferencialmente carregada do .env
